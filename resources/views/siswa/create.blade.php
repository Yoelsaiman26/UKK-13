...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl p-6 text-white">
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
                <div>
                    <h2 class="text-2xl font-bold mb-2">Tambah Siswa Baru</h2>
                    <p class="text-blue-100">Tambahkan siswa baru untuk sistem sekolah</p>
                </div>
            </div>
    ...
    <div class="bg-white rounded-lg shadow">
        ...
        <form action="{{ route('siswa.store') }}" method="post" class="p-6 space-y-6" enctype="multipart/form-data">
            @csrf

...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <!-- Pengaduan Chart -->
        <div class="bg-white rounded-lg shadow p-6">
            <h3 class="text-lg font-semibold text-gray-800 mb-4">Trend Pengaduan 6 Bulan Terakhir</h3>
        ...
        <!-- Kategori Pengaduan -->
        <div class="bg-white rounded-lg shadow p-6">
            <h3 class="text-lg font-semibold text-gray-800 mb-4">Pengaduan per Kategori</h3>
            <div class="space-y-3">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        <div class="w-3 h-3 bg-blue-500 rounded-full"></div>
                        <span class="text-sm text-gray-700">Ruang Kelas</span>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        ...
                        <span class="text-sm text-gray-700">Sarana Olahraga</span>
                    </div>
    ...
    <div class="bg-white rounded-lg shadow">
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('pengaduan.index') }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
            ...
            <table class="w-full">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <tr>
                        ...
                        <td class="px-6 py-4 text-sm text-gray-900">Kursi rusak di kelas X-IPA 2</td>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Laboratorium</td>
                        <td class="px-6 py-4 text-sm text-gray-900">Mikroskop tidak berfungsi</td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800">
                                Proses
                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">5 jam lalu</td>
                    </tr>
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Perpustakaan</td>
                        <td class="px-6 py-4 text-sm text-gray-900">AC ruang perpustakaan mati</td>
                        <td class="px-6 py-4 whitespace-nowrap">
